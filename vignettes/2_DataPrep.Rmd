...
## Step 4: Downloading the cohort / dataset
...
- To download the csv file, tick the box next to the chosen file and click on **Download** on the top right, then click on the download sign in the new window:

![Screengrab 5](../../waibel-julia-screengrabs-RAP-2021-11-28/Slide5.PNG)
...
data.table::fwrite(df_final, "../data_and_data_prep/dataset-with-preprocessing-done.csv")
```
